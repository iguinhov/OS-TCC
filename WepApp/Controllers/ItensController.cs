...
namespace WebApp.Controllers
{
    public class ItensController : Controller
    {
        ...
        public IActionResult ItemFinalizadoDetalhe(int id)
        {
            //if (Session["NomeLogin"] != null)
            //{
        ...
        // POST: Itens/Create
        [HttpPost]
        public IActionResult Create(int id, modItens item)
        {
            //if (Session["NomeLogin"] != null)
            //{
            //    try
        ...
        // GET: Itens/Edit/5
        public IActionResult FinalizarItem(int id)
        {
            //if (Session["NomeLogin"] != null)
            //{
        ...
        // POST: Itens/Edit/5
        [HttpPost]
        public IActionResult FinalizarItem(int id, modItens item)
        {
            //if (Session["NomeLogin"] != null)
            //{
        ...
        [HttpPost]
        public IActionResult AtualizaStatus(int id, modItens item)
        {
            //    if (Session["NomeLogin"] != null)
            //    {
            //        try
            ...
            //public IActionResult PesquisaItemPorStatus()
            //{
            //    if (Session["NomeLogin"] != null)
            //    {
            //        ViewBag.Status = new SelectList(dbContext.TB_STATUS_DESENVOLVIMENTO, "ID_STATUS", "DESCRICAO");
        ...
        [HttpPost]
        public IActionResult PesquisaItemPorStatus(int id)
        {            
        ...
        public IActionResult PesquisaItensFinalizadosDesenvolvedor()
        {
            //if (Session["NomeLogin"] != null)
            //{
            //    ViewBag.Desenvolvedor = new SelectList(dbContext.TB_DESENVOLVEDORES, "ID_DEV", "NOME_DESENVOLVEDOR");
        ...
        [HttpPost]
        public IActionResult PesquisaItensFinalizadosDesenvolvedor(int id)
        {
            //ViewBag.Desenvolvedor = new SelectList(dbContext.TB_DESENVOLVEDORES, "ID_DEV", "NOME_DESENVOLVEDOR");
        ...
        public IActionResult AdminsAtualizaItemAberto(int id)
        {
            //if (Session["NomeLogin"] != null)
            //{
        ...
        public IActionResult AdminsAtualizaItemAberto(int id, modItens item)
        {
            //try
            //{
